<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="adminHobiGuncelle.aspx.cs" Inherits="CV_Proje.adminHobiGuncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <form id="Form1" runat="server">
        <div class="form-group">
            ...
            <br />
            <div>
                <asp:Label ID="Label2" runat="server" Text="Hobi" CssClass="form-group"></asp:Label>
